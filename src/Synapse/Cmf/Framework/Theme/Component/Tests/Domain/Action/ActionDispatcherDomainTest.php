...
namespace Synapse\Cmf\Framework\Theme\Component\Tests\Domain\Action;

use Synapse\Cmf\Framework\Theme\Component\Action\AbstractAction;
use Synapse\Cmf\Framework\Theme\Component\Domain\Action\ActionDispatcherDomain;
use Synapse\Cmf\Framework\Theme\Component\Entity\Component;
use Majora\Framework\Domain\Action\ActionFactory;

/**
 * Unit test class for ActionDispatcher Component domain implementation.
 */
class ActionDispatcherDomainTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreate()
    {
        ...
        ;
        $action->resolve()
            ->willReturn($createdEntity = new Component())
            ->shouldBeCalled()
        ;
